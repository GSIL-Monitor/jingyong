...
def step2(yes):
    ...
    data14.to_sql('sx_all2_1',dw,if_exists='append',index=False)
    print('step2 done!!')
...
if __name__=="__main__":
    today = '2018-07-02'
    yestrday='2018-07-01'#today-datetime.timedelta(days=1)
    ...
    print(s_data3.columns)
    s_data3.columns=['cx_day','仲裁还款人数','失信还款人数','新客还款人数','老客还款人数','诉讼还款人数','还款金额']

    s_data3.to_sql('lose3',dw,index=False,if_exists='replace')
    conn_close()
    # print(day_list)
