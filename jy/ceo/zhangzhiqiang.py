...
def yihuan():
    acct_tran_detial_sql = """
        ...
        loan_id,
        CASE
    WHEN tran_detail_type = 'RPLA' THEN
        'RPLD'
    WHEN tran_detail_type = 'RPLB' THEN
        'RPLD'
    WHEN tran_detail_type = 'RPLC' THEN
        'RPLD'
    ELSE
        tran_detail_type
    END,
    ...
    WHERE
        CREATE_TIME > '2018-03-01' and TRAN_DETAIL_TYPE in('RPLA','RPLB','RPLC','RPLD','RPLI','RPPI','RPLP','RPLQ','RPMF','XXFU','BXFD')
    """
